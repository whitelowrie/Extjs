...
folder are mapped to the application's root namespace, 'DataCart10'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "DataCart10"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'DataCart10' in the same way
as `"DataCart10/sass/src"`.
